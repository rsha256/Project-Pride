...
//jQuery for timeline
$('#curr-year').click(function (e) {
  e.preventDefault();
  if ($('#prev-year').hasClass("active")) {
    $("#first").toggle();
    $("#second").toggle();
    $(".boxedbutton").toggle();
  }
  $('#prev-year').removeClass("active");
  $('#curr-year').addClass("active");

  $('#circle').animate({
    'left': '51.7%'
  });
});
$('#prev-year').click(function (e) {
  e.preventDefault();
  if ($('#curr-year').hasClass("active")) {
    $("#first").toggle();
    $("#second").toggle();
    $(".boxedbutton").toggle();
  }
  $('#curr-year').removeClass("active");
  $('#prev-year').addClass("active");
